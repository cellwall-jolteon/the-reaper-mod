...
import static reapermod.TheReaperMod.characterPath;
import static reapermod.TheReaperMod.makeID;

public class TheReaper extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("The Reaper"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass REAPER;
        @SpireEnum(name = "REAPER_BLACK_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "REAPER_BLACK_COLOR") @SuppressWarnings("unused")
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new TheReaper(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
