...
public class BowShot extends BaseCard {
    public static final String ID = makeID("BowShot"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
