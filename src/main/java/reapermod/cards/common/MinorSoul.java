...
public class MinorSoul extends BaseCard {
    public static final String ID = makeID("MinorSoul"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
