package reapermod.cards.common;
...
public class UmbrellaStrike extends BaseCard {
    public static final String ID = makeID("UmbrellaStrike"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
