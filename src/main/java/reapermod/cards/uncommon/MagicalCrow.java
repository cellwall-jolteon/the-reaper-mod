...
public class MagicalCrow extends BaseCard {
    public static final String ID = makeID("MagicalCrow"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    private static final boolean UPG_INNATE = true;
    private static final int UPG_COST = 2;

    public MagicalCrow() {
        super(ID, info); //Pass the required information to the BaseCard constructor.
        setInnate(INNATE, UPG_INNATE);
