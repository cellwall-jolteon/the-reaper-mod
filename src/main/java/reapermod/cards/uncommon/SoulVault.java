...
public class SoulVault extends BaseCard {
    public static final String ID = makeID("SoulVault"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
